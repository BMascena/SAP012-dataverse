...
* A aplicação permite o usuário visualizar dados estatísticos, a partir das informações filtradas.
...
O objetivo dessa pasta é a manipulação de dados por meio de arrays
e objetos.
